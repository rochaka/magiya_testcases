...
public class Fleet_Type {
    ...
    void shift() throws InterruptedException {
        ...
        Thread.sleep(1000);
        WebElement Stations = Login.driver.findElement(By.xpath("//*[@id=\"collapsible-resource-manager-desktop\"]/div/div[2]/div/div[1]/div/div/div[3]/a"));
        Stations.click();
    ...
    void Data() throws IOException, InterruptedException {String filePath = "src/test/java/Input_user_data/Fleet_user_data/Fleet Types"; // Replace with the path to your userdata.txt file
        ...
        Login.driver.findElement(By.xpath("//*[@id=\"nova\"]/div[2]/div[2]/div[1]/form/div[1]/div/div/div[1]")).click();
        ...
        //Model
        Login.driver.findElement(By.id("model-create-fleet-type-text-field")).sendKeys(userData.get(1));

        //year
        //driver.findElement(By.id("year-create-fleet-type-text-field")).sendKeys(userData.get(2));

        //Seating Area Term
        Login.driver.findElement(By.id("seating_area_term")).click();
        Thread.sleep(1000);
    }
