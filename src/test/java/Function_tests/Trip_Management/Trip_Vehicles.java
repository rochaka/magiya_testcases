...
public class Trip_Vehicles {
    ...
    void shift() throws InterruptedException {
        ...
        Thread.sleep(1000);
        WebElement Stations = Login.driver.findElement(By.xpath("//*[@id=\"collapsible-resource-manager-desktop\"]/div/div[2]/div/div[2]/div/div/div[2]/a"));
        Stations.click();
    ...
    void data() throws InterruptedException, IOException {
        ...
        //Type
        final WebElement Trip_Vehicle = Login.driver.findElement(By.xpath("/html//div[@id='nova']/div[2]//form[@class='space-y-8']/div[@class='space-y-4']/div/div/div[1]"));
        Trip_Vehicle.click();

        WebElement Trip_Vehicle_input = Login.driver.findElement(By.xpath("//input[@placeholder='Search']"));
        ...
        //Station
        final WebElement Trip_Vehicle_Station = Login.driver.findElement(By.xpath("/html//div[@id='nova']//form[@class='space-y-8']/div[@class='space-y-4']/div/div/div[2]"));
        Trip_Vehicle_Station.click();

        WebElement Trip_Vehicle_Station_input = Login.driver.findElement(By.xpath("//input[@placeholder='Search']"));
        Trip_Vehicle_Station_input.sendKeys(userData.get(1));
        Thread.sleep(2000);

        Login.driver.findElement(By.xpath("(//div[@class='text-sm font-semibold leading-normal text-white dark:text-gray-900'])[1]")).click();

        WebElement Registered_Number = Login.driver.findElement(By.id("register_no-create-trip-vehicle-text-field"));
        Registered_Number.sendKeys(userData.get(2));

        WebElement Engine_Number = Login.driver.findElement(By.id("engine_no-create-trip-vehicle-text-field"));
        Engine_Number.sendKeys(userData.get(3));

        WebElement Chasis_Number = Login.driver.findElement(By.id("chasis_no-create-trip-vehicle-text-field"));
        Chasis_Number.sendKeys(userData.get(4));

        WebElement Model_Number = Login.driver.findElement(By.id("model_no-create-trip-vehicle-text-field"));
