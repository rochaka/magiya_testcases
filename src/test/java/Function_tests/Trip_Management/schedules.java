package Function_tests.Trip_Management;
...
public class schedules {
    ...
    void shift() throws InterruptedException {
        ...
        Login.driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));

        Login.driver.findElement(By.xpath("(//*[name()='path'][@stroke-linecap='round'])[7]")).click();

        //create Create Fleet Brand button
        Thread.sleep(2000);
        WebElement Stations = Login.driver.findElement(By.xpath("//*[@id=\"collapsible-resource-manager-desktop\"]/div/div[2]/div/div[2]/div/div/div[5]/a"));
        Stations.click();
    ...
    void data() throws IOException, InterruptedException {
        ...
        //date
        Thread.sleep(1000);
        Login.driver.findElement(By.id("date-create-trip-schedule-date-field")).sendKeys(userData.get(0));
        ...
        //Vehicle
        Login.driver.findElement(By.xpath("/html//div[@id='nova']/div[2]//form[@class='space-y-8']/div[@class='space-y-4']/div/div/div[3]")).click();

        Login.driver.findElement(By.xpath("//input[@placeholder='Search']")).sendKeys(userData.get(2));

        Login.driver.findElement(By.xpath("(//div[@class='text-sm font-semibold leading-normal text-white dark:text-gray-900'])[1]")).click();

        //Driver
        final WebElement Schedule_Driver = Login.driver.findElement(By.xpath("/html//div[@id='nova']/div[2]//form[@class='space-y-8']/div[@class='space-y-4']/div/div/div[4]"));
        Schedule_Driver.click();

        WebElement Schedule_Driver_input = Login.driver.findElement(By.xpath("//input[@placeholder='Search']"));
        Schedule_Driver_input.sendKeys(userData.get(3));

        Login.driver.findElement(By.xpath("(//div[@class='text-sm font-semibold leading-normal text-white dark:text-gray-900'])[1]")).click();

        //Assistant
        final WebElement Schedule_Assistant = Login.driver.findElement(By.xpath("/html//div[@id='nova']/div[2]//form[@class='space-y-8']/div[@class='space-y-4']/div/div/div[5]"));
        Schedule_Assistant.click();

        WebElement Schedule_Assistant_input = Login.driver.findElement(By.xpath("//input[@placeholder='Search']"));
        Schedule_Assistant_input.sendKeys(userData.get(4));

        Login.driver.findElement(By.xpath("(//div[@class='text-sm font-semibold leading-normal text-white dark:text-gray-900'])[1]")).click();


        WebElement Add_Seat_Layout = Login.driver.findElement(By.id("name-default-text-field"));
