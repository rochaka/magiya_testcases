...
public class registration {
    ...
    void User() throws IOException {
        ...
        driver.findElement(By.cssSelector("input[placeholder='Search']")).sendKeys(userData.get(4));
    ...
    void compire() {
        ...
        try {
            errorMessage = driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[1]/form/div[1]/div/div/div[2]/div[2]/p"));
